...
subjects = {'101', '102'};
choice = {'input\choice_101.xlsx', 'input\choice_102.xlsx'};
      
rate1  = {'input\rate1_101.xlsx', 'input\rate1_102.xlsx'};

rate2  = {'input\rate2_101.xlsx', 'input\rate2_102.xlsx'};
[black_data, black_text]= xlsread('input\Bratings.xlsx');

% results files
results_file = 'Choice_indecies_test.txt';
...
for sub = 1 : length(subjects)
   ...
   % Generate inputs for hddm analyses for the subject
    ...
    hddm_Xfile = [pathH  subject '_hddm_test.xlsx'];
    hddm_file = [pathH  subject '_hddm_test.csv'];
